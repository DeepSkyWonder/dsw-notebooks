...
Objects['Clamshell'].constraint_add(type='LOCKED_TRACK')
Objects['Clamshell'].constraints["Locked Track"].target = star_blue
Objects['Clamshell'].constraints["Locked Track"].track_axis = 'TRACK_X'

Objects['Mount'].constraint_add(type='LOCKED_TRACK')
Objects['Mount'].constraints["Locked Track"].target = star_blue
Objects['Mount'].constraints["Locked Track"].track_axis = 'TRACK_Y'

Objects['Telescope'].constraint_add(type='TRACK_TO')
Objects['Telescope'].constraints["Track To"].target = star_blue
Objects['Telescope'].constraints["Track To"].track_axis = 'TRACK_Z'
