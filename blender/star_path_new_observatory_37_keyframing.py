...
def create_curve_from_dataframe(dataframe, index):
    ...
    last_row =  len(dataframe_star_path) -1
    x, y, z = dataframe_star_path[f'X_{(index+1):02}'][last_row], dataframe_star_path[f'Y_{(index+1):02}'][last_row], dataframe_star_path[f'Z_{(index+1):02}'][last_row]
    spline.points[len(dataframe_star_path)].co = (0.0, 0.0, 0.0, 1)
