...
obj_02 = object_from_data(data, name + '_02', scene)
...
json_path = os.path.join(json_base_path, 'half_sphere_quad.json')
...
obj_03 = object_from_data(mesh_data, name + '_03', scene)
