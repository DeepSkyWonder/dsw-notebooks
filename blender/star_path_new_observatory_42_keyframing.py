...
star_sun = add_star(scale=0.045, location=(0.7071, -0.7071, 0), name='Star_Sun')
...
emission_strength_star_sun = 34.00
...
star_sun_material = create_colored_emission_material('sun_star_material', color_star_sun, emission_strength_star_sun)
