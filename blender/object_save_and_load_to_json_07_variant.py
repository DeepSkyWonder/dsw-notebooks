...
def create_material(material_data):
    ...
    for node in material_data['links']:
        ...
        link_in = mat_nodes[material_data['links'][node]['In'][0]].outputs[material_data['links'][node]['In'][1]]

        material.node_tree.links.new(link_out, link_in)    
