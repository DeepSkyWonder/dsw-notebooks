...
bsdf_material['node_data'] = {
    ...
    'N_PBSDF': {'Subsurface': 'subsurf'},
    'N_PBSDF': {'Subsurface Color': 'subsurf_color'}, 
    'N_PBSDF': {'Subsurface IOR': 'subsurf_IOR'},
    'N_PBSDF': {'Metallic': 'metal'},
    'N_PBSDF': {'Specular': 'specular'},
    'N_PBSDF': {'Roughness': 'rough'},
    'N_PBSDF': {'Sheen': 'sheen'},
    'N_PBSDF': {'Sheen Tint': 'sheen_tint'},
    'N_PBSDF': {'Clearcoat': 'clear'},
    'N_PBSDF': {'Clearcoat Roughness': 'clear_rough'},
    'N_PBSDF': {'IOR': 'IOR'},
    'N_PBSDF': {'Transmission': 'trans'},
    'N_PBSDF': {'Transmission Roughness': 'trans_rough'},
    'N_PBSDF': {'Emission': 'emiss_color'},
    'N_PBSDF': {'Emission Strength': 'emiss_strength'},
    'N_PBSDF': {'Alpha': 'alpha'},
    }
...
obs_dome_base_material = bsdf_material.copy()
    
obs_dome_base_material['data'] = {
    'color_bsdf': color_white,
    'metal': 0.505,
    'specular': 0.5,
    'rough': 0.25,
...
obs_base_ring_material = bsdf_material.copy()

color_base_ring = hex_to_gamma_corrected_blender_color('#205EE7')
    
obs_base_ring_material['data'] = {
...
render_df = paths_df[147:148].copy()
