...
compass_points_label_material, Keyframe_Datapaths['text_emission_color_value'], Keyframe_Datapaths['text_emission_strenth_value'] = create_colored_material('South_Text_Material', text_base_color, text_emission_color, 1.0, 1.0)
    ...
    for index_objects, object in enumerate(objects):
        ...
        if index_objects == 3:
            ...
            if DAY:
                    ...
                    Keyframe_Datapaths['text_emission_strenth_value'].default_value = 7.0
            ...
            if index_objects == 3:
                ...
                if DAY_NIGHT:
                    ...
                    if dataset[f'DAY'][index_dataset]:
                        ...
                        Keyframe_Datapaths['text_emission_strenth_value'].default_value = 1.0                
                        Keyframe_Datapaths['text_emission_strenth_value'].keyframe_insert('default_value', frame = index_dataset)
...
Colors['compass_text_background_day'] = hex_to_gamma_corrected_blender_color('#E43F15')
