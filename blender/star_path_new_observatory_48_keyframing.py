...
def build_animation(dataset, objects, Keyframe_Datapaths, Colors):
    ...
    for index_dataset in dataset.index: 
        ...
        for index_objects, object in enumerate(objects):
            ...
            if dataset[f'DAY_{(index_objects+1):02}'][index_dataset]:
            
                Keyframe_Datapaths['world_background_color'].inputs['Color'].default_value = Colors['color_world_background_day']
                Keyframe_Datapaths['world_background_color'].keyframe_insert('default_value', frame = index_dataset)
                
            elif dataset[f'NIGHT_{(index_objects+1):02}'][index_dataset]:
                
                Keyframe_Datapaths['world_background_color'].inputs['Color'].default_value = Colors['color_world_background_night']
                Keyframe_Datapaths['world_background_color'].keyframe_insert('default_value', frame = index_dataset)
...
Colors['color_world_background_day'] = color_world_background
Colors['color_world_background_night'] = hex_to_gamma_corrected_blender_color('#2775EC')
