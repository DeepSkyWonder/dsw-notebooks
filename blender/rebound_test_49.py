...
class astroviz:
    ...
    def bevel_and_subdivide(object, BEVEL=False, bevel_segments=5, bevel_width=0.01, /
        ...
        if SUBDIV:
            ...
            subdiv = object.modifiers.get("SubDiv") or objectmodifiers.new('SubDiv', 'SUBSURF')
    ...
    def import_fbx(self, obs_fbx_filename, name, scale):
        ...
        set_smooth(object)
        recalculate_normals(object.data)
...
for star_index in range(number_of_stars):
    ...
    astrov.import_fbx('corrected_quad_sphere.fbx', star_name, 1.0)
    star_object = astrov.Objects[star_name]
    ...
    # Add subdiv modifier to star
    bevel_and_subdivide(object, BEVEL=False, SUBDIV=True, subdivision_type='CATMULL_CLARK', /
        subdiv_quality=3, subdiv_levels=3, subdiv_render_levels=3)
