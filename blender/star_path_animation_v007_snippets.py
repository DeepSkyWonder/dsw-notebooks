...
color_star_yellow = hex_to_blender_color('#364E62')

emission_strength_star_blue = 28.3
emission_strength_star_red = 25.9
emission_strength_star_yellow = 0.146
...
node_environment.image = bpy.data.images.load(meadow_hdri_texture) # Relative path
...
# ShaderNodeLightPath https://docs.blender.org/api/current/bpy.types.ShaderNodeLightPath.html#bpy.types.ShaderNodeLightPath



bpy.data.images["meadow_at_night.hdr"].name
