...
class astroviz:
    ...
    def __init__(self, render_config=None, camera_config=None):
    ...
    def configure_render(self):
        ...
        if self.render_config['engine'] == 'CYCLES':
            ...
            scene.cycles.samples = self.render_config['cycles_samples']
    ...
    def add_camera(self, name='Camera'):
        ...
        if self.camera_config['perspective']:
            context.object.data.type = 'PERSPECTIVE'
        else:
            context.object.data.type = 'ORTHO'
            context.object.data.ortho_scale = ortho_scale
            
        # Set camera location, rotation, and scale
        self.set_camera_location_rotation_scale(self, camera, location, rotation, scale)
...
s
        ...
        set_camera_location_rotation(location, rotation, scale)
...
layer_collection = bpy.context.view_layer.layer_collection.children[collections['Stars'].name]
