...
class astroviz:
    ...
    def setup_paths(self):
        ...
        if self.Paths.get('base_path') is not None:
    ...
    def import_fbx(self, obs_fbx_basepath, obs_fbx_filename):
        
        # Import Observatory into Scene
        obs_fbx_filepath = os.path.join(obs_fbx_basepath, 'clamshell_observatory_10.fbx')
