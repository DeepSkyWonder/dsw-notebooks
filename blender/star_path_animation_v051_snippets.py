...
rotate_camera_location_and_rotation_z_axis(90)  # Rotate camera's location and rotation by 45 degrees around the Z-axis
...
rotate_object_about_z_axis(text_objects['East'], 90.0)
