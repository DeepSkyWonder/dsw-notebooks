...
#=====================================================================
# Utility Function to Create 3D Functions
#=====================================================================

#=====================================================================
# 	(1) Generate and Orientate Text
#=====================================================================
...
#=====================================================================
# 	(3) Apply a Material to an Object
#=====================================================================
...
#=====================================================================
# 	(4) Set Initial Camera Rotation and Location
#=====================================================================
...
#=====================================================================
# 	(5) Rotate Camera about z-axis, & keep it pointing towards scene
#=====================================================================
...
#=====================================================================
# 	(1) Create Text for Compass Direction and Orientate Towards Camera
#=====================================================================
...
#=====================================================================
# 	(2) Set camera location/rotation and rotate about z-axis
#=====================================================================
...
# Rotate Camera about z-axis while maintaining view of scene
rotation_about_z_axis = 180
rotate_camera_location_and_rotation_z_axis(rotation_about_z_axis)  # Rotate camera's location and rotation by 45 degrees around the Z-axis

#=====================================================================
# 	(3) Orientate Compass Direction Labels
#=====================================================================

# Rotate South Text Object 180 degrees from North to South   
rotation_about_z_axis = 180  
rotate_object_about_z_axis(text_objects['South'], rotation_about_z_axis)

#=====================================================================
# 	(4) Load Dataset for Star Paths
#=====================================================================
...
def add_circle_profile_to_curve(obj, radius):
    ...
    # Get the node tree of the Geometry Nodes modifier
    #node_tree = modifier.node_group

    # Clear existing nodes
    #if not(node_tree == None):
    #    node_tree.nodes.clear()

    # Create nodes for the Geometry Nodes modifier
    ...
    links.new(node_profile.outputs['Mesh'], group_out.inputs['Geometry'])
    links.new(node_circle.outputs['Curve'], node_profile.inputs['Profile Curve'])
    node_circle.inputs[4].default_value = radius


radius = 0.002  # Example radius
add_circle_profile_to_curve(curve_object, radius)

def add_emission_material(obj, color, strength):
    # Create a new material
...
add_emission_material(curve_object, slooh_red, 2)