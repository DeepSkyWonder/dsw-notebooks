...
star_path_data = os.path.join(base_path, 'star_path.csv') # Path data for stars in CSV format
...
#path_df = pd.read_csv(star_path_data)
...
star_path_object_01 = create_curve_from_dataframe(paths_df)
...
# Add circular profile to star_path curve   
circel_profile_radius = 0.002 
add_circle_profile_to_curve(star_path_object_01, circel_profile_radius)

# Add emission material to star_path curve
add_emission_material(star_path_object_01, slooh_red, 1.2)

emission_color_star_path_blue = color_star_blue
emission_strength_star_path_blue = 1.2
blue_star_path_material = create_colored_emission_material('blue_star_path_material', color_star_blue, emission_strength_star_path_blue)
apply_material_to_object(star_path_object_01, blue_star_path_material)
