...
for star_index in range(number_of_stars):
    ...
    astrov.Objects[star_name].location = (0.0, float(star_index) * 3.0 , 1.0)
    rotation_degrees = (0.0, 0.0, 0.0)
    astrov.Objects[star_name].rotation_euler = [math.radians(angle) for angle in rotation_degrees]
