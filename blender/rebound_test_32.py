...
class astroviz:
    ...
    def add_color(self, name, color_hex):
        ...
        color = hex_to_gamma_corrected_blender_color(color_hex)
    ...
    def setup_slooh_colors(self):
        ...
        add_color('slooh_gold', '#B09C78')
        add_color('slooh_bright_gold', '#E4C490')
        add_color('slooh_red', '#DB6448')
        add_color('slooh_light_blue', '#00A2FF')
        add_color('slooh_background_blue', '#202E40')
        add_color('slooh_light_background_blue', '#40556E')
