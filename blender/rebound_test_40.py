...
class astroviz:
    ...
    def import_fbx(self, obs_fbx_filename, scale):
        
        # Import Observatory into Scene
        obs_fbx_filepath = os.path.join(self.Paths['folder_FBX'], 'clamshell_observatory_10.fbx')
...
astrov.import_fbx('clamshell_observatory_10.fbx', 0.085)
