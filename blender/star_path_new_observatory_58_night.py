...
star_objects = [star_yellow, star_red, star_blue, star_sun]
...
star_colors = [color_star_yellow, color_star_red, color_star_blue, color_star_sun]
stars_materials_names = ['yellow_star_path_material', 'red_star_path_material', 'blue_star_path_material', 'sun_star_path_material',]
star_emission_strengths = [1.5, 1.8, 3.2, 1.2]
star_materials = []
